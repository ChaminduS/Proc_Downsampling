...
set_property webtalk.parent_dir {F:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/Vivado/proc_downsample/proc_downsample.cache/wt} [current_project]
set_property parent.project_path {F:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/Vivado/proc_downsample/proc_downsample.xpr} [current_project]
set_property default_lib xil_defaultlib [current_project]
set_property target_language Verilog [current_project]
set_property board_part xilinx.com:zcu102:part0:3.3 [current_project]
set_property ip_output_repo {f:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/Vivado/proc_downsample/proc_downsample.cache/ip} [current_project]
...
synth_design -top processor -part xczu9eg-ffvb1156-2-e
