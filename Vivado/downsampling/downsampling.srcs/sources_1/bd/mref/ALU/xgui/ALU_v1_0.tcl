...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "LSHIFT9" -parent ${Page_0}
...
proc update_PARAM_VALUE.LSHIFT9 { PARAM_VALUE.LSHIFT9 } {
	# Procedure called to update LSHIFT9 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LSHIFT9 { PARAM_VALUE.LSHIFT9 } {
	# Procedure called to validate LSHIFT9
	return true
}
...
proc update_MODELPARAM_VALUE.LSHIFT9 { MODELPARAM_VALUE.LSHIFT9 PARAM_VALUE.LSHIFT9 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LSHIFT9}] ${MODELPARAM_VALUE.LSHIFT9}
}
