...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "F:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/Vivado/.Xil/Vivado-8732-Chamindu-PC/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog {
      {F:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/src/ALU.v}
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "F:/5th semester ENTC/1 - EN3030 - Circuits and Systems Design/Proc_downsampling/Vivado/.Xil/Vivado-8732-Chamindu-PC/"
